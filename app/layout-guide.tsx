export default function LayoutGuide() {
  return (
    <div className="container mx-auto px-4 md:px-8 py-12">
      <h1 className="text-3xl md:text-4xl font-medium mb-8 font-heading">Juliana Duran Website Layout Guide</h1>
      ...
      <div className="space-y-12">
        <section>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-medium mb-2 font-heading">Standard Container</h3>
              ...
              <p className="mt-4">Alternatively, use the LayoutContainer component:</p>
              <div className="bg-gray-100 p-4 rounded-md">
                <code className="text-sm font-mono">
                  &lt;LayoutContainer&gt;
                  <br />
            ...
            <div>
              ...
              <ol className="mt-4 list-decimal pl-6 space-y-2 text-gray-700">
                ...
                <li>Page content sections (each wrapped in container)</li>
                <li>Footer</li>
              </ol>
            </div>
