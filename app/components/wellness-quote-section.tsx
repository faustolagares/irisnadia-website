...
export default function WellnessQuoteSection() {
  ...
  return (
    <section ref={ref} className="relative w-full h-[700px] md:h-[600px] lg:h-[700px] overflow-hidden py-16 md:py-20">
      {/* Imagem de fundo */}
      ...
      <div className="relative h-full container mx-auto px-4 md:px-8 flex items-center">
        ...
        >
          ...
          <blockquote className="text-gray-800 text-xl md:text-2xl font-heading font-light leading-relaxed mb-6">
            ...
            A missão é valorizar essa história com resultados sutis, seguros e naturais — sempre com respeito à individualidade."
          </blockquote>

          {/* Atribuição */}
          <cite className="text-gray-600 font-heading text-sm block">— Dra. Irisnádia Faria</cite>
        </motion.div>
      </div>
    </section>
  )
